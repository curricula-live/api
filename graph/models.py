...
class Relation(models.Model):
    ...
    class Meta:
        db_table = "relation"
        constraints = [models.UniqueConstraint(fields=["source", "target", "type"], name="unique_typed_relation")]
        indexes = [models.Index(fields=["source", "type"]), models.Index(fields=["target", "type"])]
